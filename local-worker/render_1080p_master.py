"""Render Master 1080p Full HD Douyin Video:
- Target resolution: 1080x1920 Full HD (Chuẩn vàng TikTok / Reels / Shorts)
- Demucs Clean BGM
- 29 Synced CapCut Voices (Mai BV421)
- Frosted Glassmorphism Subtitle Bar
"""
...
print(f"📐 Target Full HD: {width}x{height}")
...
print("🎞️ Đang render file 1080p Full HD Master MP4...")
t0 = time.time()
subprocess.run(full_cmd, check=True)
render_time = time.time() - t0
print(f"🎉 RENDER 1080p THÀNH CÔNG trong {render_time:.1f}s!")
print(f"📁 Video Master 1080p: {final_output}")
